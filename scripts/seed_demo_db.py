...
SCENES = [
    ...
    {
        "tag": "04b_roblox_safe_obby",
        "platform": "Roblox",
        "minutes_ago": 42,
        "duration_min": 6,
        "participants": ["kai_bloxx", "peachyfin"],
        "messages": [
            ("kai_bloxx", "wait i need more robux for the pass"),
            ("peachyfin", "lol save up dude"),
            ("child",     "i can carry us through the obby"),
            ("kai_bloxx", "bet u cant beat my time"),
            ("child",     "bet"),
            ("peachyfin", "gg fr"),
        ],
        "status": {
            ...
            "category": "none",
            "confidence": 94,
            "short_summary": "Three friends racing an obby together; normal game chat.",
            "narrative": "Peer group chatting about in-game purchases and racing through an obstacle course. Friendly, reciprocal banter.",
            "reasoning": "Named friend handles, on-topic game discussion, no strangers, no off-platform migration. Standard Roblox friend chat.",
            "indicators": [],
            "grooming_stage": "none",
            "parent_alert_recommended": False,
            "certainty": "high",
    ...
    {
        "tag": "09b_minecraft_alert_bullying",
        "platform": "Minecraft",
        "minutes_ago": 6,
        "duration_min": 3,
        "participants": ["knifecore_", "_shardrat_", "mooncrypt"],
        "messages": [
            ...
            ("child",      "why are u guys like this"),
        ...
        "status": {
            ...
            "category": "bullying",
            "confidence": 94,
            "short_summary": "Three players pile on, insult the child's build, destroy their base, and order them off the server.",
            "narrative": "Coordinated griefing and pile-on by three distinct accounts. Insults target the child's creative work ('5yo build'), followed by actual server griefing (destroying the base) and exclusion language ('nobody wants u here', 'get off MY server').",
            "reasoning": "Every bullying marker is present at once: multi-user pile-on, targeted mockery of the child's output, destructive griefing as intimidation, and explicit social exclusion. The child's single attempt at self-defense ('why are u guys like this') is met with more insults. Clear alert.",
            "indicators": [
                "pile-on",
                "targeted mockery",
                "griefing as intimidation",
